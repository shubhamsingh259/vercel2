...
<head>
	<title>Beauty Salon a Beauty Category Bootstrap Responsive website Template | Typography :: w3layouts</title>
	<!-- Meta Tags -->
			...
			<nav class="navbar navbar-default shift">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
								<a class="active" href="#" class="dropdown-toggle effect-3" data-toggle="dropdown">Pages<b class="caret"></b></a>
